	...
	public static byte[] hash(final byte[] input) {
		...
		while (inputOffset <= inputLength) {
			...
			for (i = 0; i < 25;) {
				...
				t12 = state1 ^ (t3 = (t1 = state0 ^ state5 ^ state10 ^ state15 ^ state20)
						^ (((t2 = state2 ^ state7 ^ state12 ^ state17 ^ state22) << 1) | (t2 >>> -1)));
				t13 = state2 ^ (t6 = (t4 = state1 ^ state6 ^ state11 ^ state16 ^ state21)
						^ (((t5 = state3 ^ state8 ^ state13 ^ state18 ^ state23) << 1) | (t5 >>> -1)));
				state0 = (t9 = state0
						^ (t8 = ((t4 << 1) | (t4 >>> -1)) ^ (t7 = state4 ^ state9 ^ state14 ^ state19 ^ state24)))
						^ ((~(t16 = ((t16 = state6 ^ t3) << 44) | (t16 >>> -44)))
								& (state2 = ((state2 = state12 ^ t6) << 43) | (state2 >>> -43)))
						^ KNV25.constants[i++];
				...
				t16 = state5 ^ t8;
				t17 = state7 ^ t6;
				state5 = (t14 = (t14 << 28) | (t14 >>> -28)) ^ ((~(t19 = ((t19 = state9 ^ t11) << 20) | (t19 >>> -20)))
						& (state7 = ((state7 = state10 ^ t8) << 3) | (state7 >>> -3)));
				t18 = state8 ^ t10;
				...
				state9 ^= (~t14) & t19;
				t19 = state11 ^ t3;
				state10 = (t12 = (t12 << 1) | (t12 >>> -1)) ^ ((~(t17 = (t17 << 6) | (t17 >>> -6)))
						& (state12 = ((state12 = state13 ^ t10) << 25) | (state12 >>> -25)));
				...
				t12 = state15 ^ t8;
				t17 = state17 ^ t6;
				state15 = (t15 = (t15 << 27) | (t15 >>> -27))
						^ ((~(t16 = (t16 << 36) | (t16 >>> -36))) & (state17 = (t19 << 10) | (t19 >>> -10)));
				state16 = t16 ^ ((~state17) & (state18 = (t17 << 15) | (t17 >>> -15)));
				state17 ^= (~state18) & (state19 = ((state19 = state23 ^ t10) << 56) | (state19 >>> -56));
				state18 ^= (~state19) & t15;
				state19 ^= (~t15) & t16;
				t19 = state21 ^ t3;
				state20 = (t13 = (t13 << 62) | (t13 >>> -62))
						^ ((~(t18 = (t18 << 55) | (t18 >>> -55))) & (state22 = (t14 << 39) | (t14 >>> -39)));
