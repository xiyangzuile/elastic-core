...
public final class DbUtils {
	...
	private static <T> T[] getArray(final ResultSet rs, final String columnName, final Class<? extends T[]> cls,
	...
	public static String limitsClause(final int from, final int to) {
		...
		if ((limit > 0) && (from > 0)) return " LIMIT ? OFFSET ? ";
        else if (limit > 0) return " LIMIT ? ";
        else if (from > 0) return " LIMIT NULL OFFSET ? ";
        else return "";
	}
