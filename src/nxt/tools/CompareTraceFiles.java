...
final class CompareTraceFiles {
	...
	public static void main(final String[] args) {
		final String testFile = args.length > 0 ? args[0] : "nxt-trace.csv";
		final String defaultFile = args.length > 1 ? args[1] : "nxt-trace-default.csv";
	...
	private static int parseHeight(final String line) {
