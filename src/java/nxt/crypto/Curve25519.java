...
final class Curve25519 {
	...
	private static final class long10 {
		...
		public long10() {}
		public long10(
				final long _0, final long _1, final long _2, final long _3, final long _4,
				final long _5, final long _6, final long _7, final long _8, final long _9)
		{
	...
	private static boolean is_overflow(final long10 x) {
		return (
				((x._0 > (Curve25519.P26-19))) &&
				((x._1 & x._3 & x._5 & x._7 & x._9) == Curve25519.P25) &&
				((x._2 & x._4 & x._6 & x._8) == Curve25519.P26)
				) || (x._9 > Curve25519.P25);
	}
	...
	private static void mont_add(final long10 t1, final long10 t2, final long10 t3, final long10 t4,final long10 ax, final long10 az, final long10 dx) {
	 ...
	 *  X(Q) = (t3+t4)/(t3-t4)
	 * clobbers t1 and t2, preserves t3 and t4  */
	private static void mont_dbl(final long10 t1, final long10 t2, final long10 t3, final long10 t4,final long10 bx, final long10 bz) {
	...
	private static int mula_small(final byte[] p,final byte[] q,final int m,final byte[] x,final int n,final int z) {
		int v=0;
		for (int i=0;i<n;++i) {
	...
	private static int mula32(final byte[] p, final byte[] x, final byte[] y, final int t, final int z) {
		...
		for (; i < t; i++) {
			...
			w += Curve25519.mula_small(p, p, i, x, n, zy) +
	...
	private static void recip(final long10 y, final long10 x, final int sqrtassist) {
		...
		Curve25519.mul(t3, t1, t2);	/* 31 == 22 + 9
                    == 2^5   - 2^0	*/
