...
QUnit.test("getAccountLink", function (assert) {
    ...
    NRS.contacts = { "XEL-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "XEL-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='XEL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    ...
    assert.equal(NRS.getAccountLink({ entityRS: "XEL-XK4R-7VJU-6EQG-7R335" }, "entity", "XEL-XK4R-7VJU-6EQG-7R335", "My Precious"), "<a href='#' data-user='XEL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>My Precious</a>", "force.account.name");
