...
echo "Trying $ID"
curl --data "work_id=$ID&inputs=0,0,0,0,0,0,0,0&is_pow=true&deadline=1440&feeNQT=0&n=1&secretPhrase=NoDaddyNotToday" http://127.0.0.1:6876/nxt?requestType=createPoX 
